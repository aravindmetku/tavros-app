...
const UseCaseContent: React.FC<UseCaseContentProps> = ({ activeTab }) => {
  const content = {
    ...
    government: {
      ...
      description: 'Government regulations, expanding roads, and unforeseen infrastructure projects often burden landowners with uncertainty. These factors can shrink usable land or affect value. Staying informed through regular inspections to protect assets, plan ahead, and address concerns before they escalate into costly issues'
    },
    construction: {
      title: 'Development Planning\nConstruction Monitoring\nProject Tracking',
      description: 'Frequent site visits during construction can cause stress for landowners, especially when workers provide inaccurate or incomplete information. Unaddressed issues may escalate into costly errors.'
    }
  };
  ...
  return (
    <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div className={`p-8 rounded-lg bg-coral`}>
        ...
        <div className="mt-6">
          <button className="px-8 py-3 bg-lime text-darkBg font-medium rounded-full hover:bg-opacity-90 transition-colors">
            Get Started
          </button>
        </div>
      </div>
...
export default function UseCases() {
  ...
  return (
    <section id="use-cases" className="w-full bg-darkBg text-lightText py-16 px-60">
